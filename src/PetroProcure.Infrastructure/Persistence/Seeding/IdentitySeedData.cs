    ...
    private static RolePermission[] CreateRolePermissions()
    {
        var definitions = new Dictionary<string, string[]>
        {
            ...
            [
                ...
                ApplicationPermissions.PurchaseFileRequestTechnicalReview,
                ApplicationPermissions.PurchaseFileViewTechnicalReview,
            ...
            [
                ...
                ApplicationPermissions.ApplicantViewTechnicalReviews,
                ApplicationPermissions.ApplicantSubmitTechnicalReview,
                ApplicationPermissions.ApplicantRequestClarification,
                ApplicationPermissions.ItemView,
                ApplicationPermissions.OrdersCreateMaterialNeed
            ],
