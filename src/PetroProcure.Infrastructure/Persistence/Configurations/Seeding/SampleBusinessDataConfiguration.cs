...
internal sealed class SampleIndentSeedConfiguration : IEntityTypeConfiguration<Indent>
{
    ...
    {
        Id = SeedDataIds.SampleIndentId,
        IndentNumber = "2630001",
        YearPart = 26,
        TypeDigit = 3,
        Sequence = 1,
        IndentType = IndentType.Manual,
        Title = "درخواست نمونه خرید لوله",
        RequestingDepartmentId = SeedDataIds.OrdersAndInventoryControlId,
        ApplicantDepartmentId = (Guid?)SeedDataIds.ApplicantId,
        CreatedByUserId = IdentitySeedData.DefaultAdminUserId,
        CreatedAt = SampleSeed.CreatedAt,
        Status = IndentStatus.Approved,
        Description = "داده نمونه توسعه",
        SourceType = IndentSourceType.Manual,
        SourceMaterialNeedId = (Guid?)null,
        SourceShortageAlertId = (Guid?)null,
        SourceDescription = (string?)"نمونه دستی",
        CreatedAtUtc = SampleSeed.CreatedAt,
...
internal sealed class SampleIndentItemSeedConfiguration : IEntityTypeConfiguration<IndentItem>
{
    ...
    {
        Id = SeedDataIds.SampleIndentItemId,
        IndentId = SeedDataIds.SampleIndentId,
        MescItemId = SeedDataIds.PipeItemId,
        MescCode = "1234560001",
...
internal sealed class SamplePurchaseFileSeedConfiguration : IEntityTypeConfiguration<PurchaseFile>
{
    ...
    {
        Id = SeedDataIds.SamplePurchaseFileId,
        FileNumber = "PF-2026-000001",
        Title = "پرونده نمونه خرید لوله",
        Description = "پرونده نمونه توسعه",
        Status = PurchaseFileStatus.InPurchaseDepartment,
        Priority = PurchaseFilePriority.Normal,
        SourceIndentId = (Guid?)SeedDataIds.SampleIndentId,
        PurchaseDepartmentId = SeedDataIds.PurchaseDepartmentId,
        CurrentDepartmentId = SeedDataIds.PurchaseDepartmentId,
        ResponsibleUserId = (Guid?)IdentitySeedData.DefaultAdminUserId,
        CreatedByUserId = IdentitySeedData.DefaultAdminUserId,
        CreatedAt = SampleSeed.CreatedAt,
...
internal sealed class SamplePurchaseFileItemSeedConfiguration : IEntityTypeConfiguration<PurchaseFileItem>
{
    ...
    {
        Id = SeedDataIds.SamplePurchaseFileItemId,
        PurchaseFileId = SeedDataIds.SamplePurchaseFileId,
        MescItemId = SeedDataIds.PipeItemId,
        MescCode = "1234560001",
        MescGeneralGroupCode = "123456",
        GeneralDescription = "لوله و اتصالات عمومی",
        ...
        TechnicalDescription = "نمونه تست",
        SourceIndentItemId = (Guid?)SeedDataIds.SampleIndentItemId,
        CreatedAtUtc = SampleSeed.CreatedAt,
        CreatedBy = (string?)null,
        ModifiedAtUtc = (DateTime?)null,
        ModifiedBy = (string?)null
...
internal sealed class SampleWorkflowSeedConfiguration : IEntityTypeConfiguration<WorkflowInstance>
{
    ...
    {
        Id = SeedDataIds.SampleWorkflowId,
        EntityType = "PurchaseFile",
        EntityId = SeedDataIds.SamplePurchaseFileId,
        CurrentDepartmentId = SeedDataIds.PurchaseDepartmentId,
        Status = WorkflowStatus.InProgress,
        StartedByUserId = IdentitySeedData.DefaultAdminUserId,
        StartedAt = SampleSeed.CreatedAt,
        CompletedAt = (DateTime?)null
    });
}
internal sealed class SampleWorkflowStepSeedConfiguration : IEntityTypeConfiguration<WorkflowStep>
{
    ...
    {
        Id = SeedDataIds.SampleWorkflowStepId,
        WorkflowInstanceId = SeedDataIds.SampleWorkflowId,
        FromDepartmentId = SeedDataIds.OrdersAndInventoryControlId,
        ToDepartmentId = SeedDataIds.PurchaseDepartmentId,
...
internal sealed class SampleInboxTaskSeedConfiguration : IEntityTypeConfiguration<InboxTask>
{
    ...
    {
        Id = SeedDataIds.SampleInboxTaskId,
        WorkflowInstanceId = SeedDataIds.SampleWorkflowId,
        PurchaseFileId = (Guid?)SeedDataIds.SamplePurchaseFileId,
        IndentId = (Guid?)null,
        AssignedDepartmentId = SeedDataIds.PurchaseDepartmentId,
        AssignedUserId = (Guid?)IdentitySeedData.DefaultAdminUserId,
...
internal sealed class SampleDocumentSeedConfiguration : IEntityTypeConfiguration<FileDocument>
{
    ...
    {
        Id = SeedDataIds.SampleDocumentId,
        PurchaseFileId = SeedDataIds.SamplePurchaseFileId,
        DepartmentId = (Guid?)SeedDataIds.PurchaseDepartmentId,
        DocumentType = DocumentType.Indent,
        ...
        VersionNo = 1,
        UploadedByUserId = IdentitySeedData.DefaultAdminUserId,
        UploadedAt = SampleSeed.CreatedAt,
        IsDeleted = false,
...
internal sealed class AdminDepartmentSeedConfiguration : IEntityTypeConfiguration<UserDepartment>
{
    ...
    {
        Id = SeedDataIds.AdminPurchaseDepartmentId,
        UserProfileId = IdentitySeedData.DefaultAdminProfileId,
...
internal sealed class SampleIndentSequenceSeedConfiguration : IEntityTypeConfiguration<IndentSequence>
{
    ...
    {
        Id = SeedDataIds.SampleIndentSequenceId,
        YearPart = 26,
        TypeDigit = 3,
        LastSequence = 1
    });
...
internal sealed class SamplePurchaseFileSequenceSeedConfiguration : IEntityTypeConfiguration<PurchaseFileSequence>
{
    ...
    {
        Id = SeedDataIds.SamplePurchaseFileSequenceId,
        Year = 2026,
        LastSequence = 1
    });
}
