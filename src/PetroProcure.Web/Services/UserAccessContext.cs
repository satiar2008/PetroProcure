...
public sealed class UserAccessContext : IUserAccessContext, IDisposable
{
    ...
    [
        ...
        new("سفارش‌های خرید", "/purchase/purchase-orders", Icons.Material.Filled.ShoppingCart, "purchase", "PurchaseOrder.View"),
        ...
        new("رسیدهای انبار", "/warehouse/receipts", Icons.Material.Filled.ReceiptLong, "warehouse", "WarehouseReceipt.View"),
        new("سفارش‌های در انتظار رسید", "/warehouse/purchase-orders-waiting", Icons.Material.Filled.LocalShipping, "warehouse", "WarehouseReceipt.Create"),
        new("موجودی کالا", "/warehouse/stock-balances", Icons.Material.Filled.Inventory2, "warehouse", "Inventory.ViewStockBalance"),
        new("گردش موجودی", "/warehouse/inventory-transactions", Icons.Material.Filled.SyncAlt, "warehouse", "Inventory.ViewTransactions"),
        new("مدیریت انبارها", "/warehouse/manage", Icons.Material.Filled.Settings, "warehouse", "Warehouse.ManageWarehouses"),
        new("داشبورد متقاضی", "/applicant", Icons.Material.Filled.PersonPin, "applicant", "Applicant.ViewDashboard"),
        new("بررسی‌های فنی متقاضی", "/applicant/technical-reviews", Icons.Material.Filled.FactCheck, "applicant", "Applicant.ViewTechnicalReviews"),
